...
# # =====================================================
# # CREATE OR UPDATE RISK (RULE-BASED + ML)
# # =====================================================
# @risk_bp.route("/create", methods=["POST"])
# @jwt_required()
# def create_risk():
...
#     # Calculate ML score
#     ml_score, ml_risk_level = predict_risk_level(features)
...
#         existing_risk.ml_score = ml_score 
...
#     # Update ML score
#     ml_score, _ = predict_risk_level(features)
...
# =====================================================
# CREATE OR UPDATE RISK (RULE + ML HYBRID)
# =====================================================
@risk_bp.route("/create", methods=["POST"])
@jwt_required()
def create_risk():
    ...
    try:
        ...
        ml_score = 0.0  # fallback if ML not trained
...
def recalculate_risk(student_id):
    ...
    try:
        ...
        ml_score = risk.ml_score  # keep previous ML score
